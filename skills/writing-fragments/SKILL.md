...
When the user says the material is enough, or wants to start composing, stop exploring. Leave the raw-material file exactly as it stands and hand its path back to the `writing` router; picking what happens next is its job.
