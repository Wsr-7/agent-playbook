...
When the user says the article is done, stop and report the article path.
...
Search the pile for what the article needs before asking the user for it. If the pile lacks it, name the gap explicitly: "We need an example here and the pile doesn't have one. Give me one now or we cut this section."
